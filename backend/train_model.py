...
def plot_training_history(history):
    ...
    print("\nTraining history saved as 'logs/training_history.png'")
    plt.close()
...
def main():
    ...
    callbacks = [
        keras.callbacks.ModelCheckpoint(
            'models/pneumonia_model_best.keras',
        ...
        keras.callbacks.CSVLogger(f'logs/training_log_{timestamp}.csv')
    ]
    ...
    # Save final model
    model.save('models/pneumonia_model_final.keras')
    print("\nFinal model saved as 'models/pneumonia_model_final.keras'")
